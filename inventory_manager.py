...
def hurricane_shelter():
    ...
    neededRations = (peopleInHouse * numDays)
    ...
    def additional_supplies_shelter():
        print("You need a total of", math.ceil((peopleInHouse * 2) * numWeeks),
              "N95 masks to reduce the spread of Covid-19.")
        # This is a rough estimate, you can be the judge of how many masks you go through.
        print("You need a total of", math.ceil((peopleInHouse * numWeeks) / 2), "bottles of hand sanitizer.")
        ...
        print("You need", peopleInHouse, "flashlights, and", peopleInHouse, "headlamps.")
        ...
        print("You need", math.ceil(peopleInHouse * numDays * 1.5), "protein bars.")
        ...
        # possibly want.
        print("You need", math.ceil((peopleInHouse * numDays) / 3), "boxes of Cosmic Brownies.")
    ...
    def output_text():
        sys.stdout = open("Inventory_Report.txt", "w")
...
def hurricane_evacuation():
    ...
    numDaysTraveling = int(input())
    print("How many gallons of water do you have in your vehicle?")
